...
appliances: ['Small Appliances', 'Refrigeration', 'Air Conditioning', 'Laundry'],'pet-supplies': ['Dog Supplies', 'Cat Supplies', 'Fish & Aquatic', 'Birds', 'Small Animals', 'Reptiles'],'baby-products': ['Feeding', 'Diapers', 'Toys', 'Clothing', 'Safety', 'Strollers'],
